...
| 文書 | 内容 | 対象読者 |
|------|------|----------|
| [システム設計書](./docs/system-design.md) | FSD構成、技術スタック、データ/状態/フロー設計 | 開発者・アーキテクト |
...
| [API設計書](./docs/api-specification.md) | データモデル、API契約、エラー/セキュリティ設計 | バックエンド・フロントエンド |
