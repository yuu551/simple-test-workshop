...
describe('validateForm', () => {
  ...
  describe('名前のバリデーション', () => {
    it('名前が空文字の場合はエラーが返される', () => {
      ...
      expect(errors.name).toBe('名前は必須項目です');
    });
  ...
  describe('メールアドレスのバリデーション', () => {
    it('メールアドレスが空文字の場合は必須エラーが返される', () => {
      ...
      const errors = validateForm(data);
      expect(errors.email).toBe('メールアドレスは必須項目です');
    });
  ...
  describe('件名のバリデーション', () => {
    it('件名が空文字の場合はエラーが返される', () => {
      ...
      const errors = validateForm(data);
      expect(errors.subject).toBe('件名は必須項目です');
    });
  ...
  describe('本文のバリデーション', () => {
    it('本文が空文字の場合はエラーが返される', () => {
      ...
      const errors = validateForm(data);
      expect(errors.message).toBe('お問い合わせ内容は必須項目です');
    });
  ...
  describe('プライバシーポリシーのバリデーション', () => {
    it('プライバシーポリシーに同意していない場合はエラーが返される', () => {
      ...
      const errors = validateForm(data);
      expect(errors.privacyPolicy).toBe('プライバシーポリシーに同意してください');
    });
...
describe('validateField', () => {
  ...
  describe('email field', () => {
    ...
    it('空のメールアドレスでエラーメッセージを返す', () => {
      ...
      expect(result).toBe('メールアドレスは必須項目です');
    });
  ...
  describe('privacyPolicy field', () => {
    ...
    it('プライバシーポリシー未同意でエラーメッセージを返す', () => {
      ...
      expect(result).toBe('プライバシーポリシーに同意してください');
    });
  });
});